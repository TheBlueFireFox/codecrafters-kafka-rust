...
mod fetch {
    ...
    fn load_cluster_metadata() -> anyhow::Result<CompactRecords> {
        use crate::messages::primitives::Deserialize;

        let path = "/tmp/kraft-combined-logs/__cluster_metadata-0/00000000000000000000.log";
        let buf = std::fs::read(path)?;
        let (res, _) = CompactRecords::parse(&buf)?;
        dbg!(&res);
...
mod test {
    ...
    fn fetch_file() {
        ...
        let cluster = [
            ...
            0x02, 0x00, 0x00, 0x00, 0x9A, 0x00, 0x00, 0x00, 0x01, 0x02, 0xEE, 0xA1, 0x07, 0xF7,
            ...
            0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x02, 0x3C, 0x00,
            0x00, 0x00, 0x01, 0x30, 0x01, 0x02, 0x00, 0x04, 0x62, 0x61, 0x7A, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x40, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x52, 0x00,
            ...
            0x00, 0x00, 0x00, 0x52, 0x02, 0x00, 0x00, 0x00, 0x01, 0x02, 0x00, 0x00, 0x00, 0x01,
            ...
            ,
